...
st.sidebar.markdown("**Contact Sources:**")
st.sidebar.markdown("✉️ Email: mayanktanwar542@gmail.com")
st.sidebar.markdown("🔗 LinkedIn: [Mayank Tanwar](https://www.linkedin.com/in/mayank-tanwar-906783255/)")
...
# ============================================================
    ...
    qa_option = st.selectbox(
        "Select Q&A Type",
        ["Factors Analysis", "Business Q&A", "Business Matrix"]
    )

    if qa_option == "Factors Analysis":
    ...
    elif qa_option == "Business Q&A":

        st.markdown("""
        <div class="glass-card">

        <h3>Amazon Prime EDA — Business Q&A</h3>

        <ol>
        <li><b>Are Movies More Dominant Than TV Shows?</b><br>
        ✅ Yes. Movies dominate the Amazon Prime catalog, contributing nearly 88% of total titles.<br>
        This shows that Amazon Prime focuses more on movie-based content to attract a larger audience.</li>

        <li><b>Has Content Production Increased Over Time?</b><br>
        ✅ Yes. The number of titles released increased rapidly after 2015, especially during the streaming boom.<br>
        This reflects Amazon Prime's aggressive content expansion strategy over recent years.</li>

        <li><b>Are Actors More Involved Than Directors?</b><br>
        ✅ Yes. Actor participation is significantly higher than director participation across the platform.<br>
        This indicates a larger collaboration network and greater content diversity in productions.</li>

        <li><b>Is There a Relationship Between IMDb and TMDb Ratings?</b><br>
        ✅ Yes. Higher IMDb ratings generally align with higher TMDb scores and popularity.<br>
        This suggests that audience perception of content quality is consistent across platforms.</li>

        <li><b>Which Content Type Performs Better?</b><br>
        ✅ Movies perform better in terms of quantity and overall platform presence.<br>
        TV Shows contribute a smaller share, while movies remain the core content driver.</li>

        <li><b>Were Initial Assumptions Correct?</b><br>
        ✅ Mostly yes. The analysis confirmed that movies dominate the platform and content production has increased over time.<br>
        It also validated the positive relationship between different rating platforms.</li>

        <li><b>How Is This Analysis Useful?</b><br>
        ✅ This analysis helps stakeholders identify content trends, audience preferences, and growth opportunities.<br>
        Marketing teams can promote popular genres, while investors can track platform expansion.</li>

        <li><b>Key Insights from the Analysis</b><br>
        🔥 The platform is heavily movie-focused, with rapid growth observed after 2015.<br>
        Ratings show strong positive correlation, and actor participation is much higher than director involvement.</li>

        <li><b>Future Improvements</b><br>
        🚀 Future enhancements can include recommendation systems, machine learning models, and AI-generated insights.<br>
        Advanced forecasting and real-time analytics can further improve business decision-making.</li>
        </ol>

        </div>
        """, unsafe_allow_html=True)

    elif qa_option == "Business Matrix":

        st.markdown("""
        <div class="glass-card">

        <h3>Amazon Prime - Business Matrix</h3>

        <p>This chart provides a comprehensive overview of key business metrics for Amazon Prime content:</p>
        <ul>
        <li><b>Actor Participation:</b> Distribution of roles (Actors vs Directors)</li>
        <li><b>Titles per Year:</b> Content production trends over time</li>
        <li><b>IMDb vs TMDb Scores:</b> Relationship between rating platforms</li>
        <li><b>Titles by Type:</b> Distribution of Movies vs TV Shows</li>
        </ul>
        ...
        <h4>Key Insights from the Business Matrix:</h4>
        <ul>
        <li><b>Actor vs Director Participation:</b> Actors significantly outnumber directors across both Movies and TV Shows</li>
        <li><b>Content Growth:</b> TV Shows show rapid growth after 2012, while Movies maintain steady production</li>
        <li><b>Rating Correlation:</b> Strong positive relationship between IMDb and TMDb scores</li>
        <li><b>Content Dominance:</b> Movies represent the majority of titles (88%), but TV Shows have higher engagement</li>
        </ul>

        <h4>Business Impact:</h4>
        <p>TV Shows are gaining popularity due to shorter formats and consistent quality. The platform should focus on TV Show production and quality improvement to maximize customer engagement and growth.</p>
